<template>
  <div class="flow-nav my-3">
    ...
    <div class="left-side">
      ...
      <!-- Title -->
      <div class="title-badge">الإدارة والمراسلات و الصادر</div>
    </div>
    ...
    <div class="center-links">
      ...
      <div
        class="nav-item"
        :class="{ active: tab === 'correspondence' }"
        @click="tab = 'correspondence'"
      >
        المراسلات
      </div>
      <div
  ...
  <!-- Dynamic Page -->
  <component :is="currentTab" :key="tab"></component>
</template>
